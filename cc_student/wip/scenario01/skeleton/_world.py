...
class World:
    def __init__(self):
        self.imageBG = Image.bind_from_path('cc_student/wip/scenario01/assets/images/space.png')
        self.imageGoal = Image.bind_from_path('cc_student/wip/scenario01/assets/images/pizza.png')
